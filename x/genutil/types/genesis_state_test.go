...
import (
	...
	stakingtypes "github.com/osiz-blockchainapp/pound-sdk/x/staking/types"
)
...
func TestNetGenesisState(t *testing.T) {
	...
	assert.NotNil(t, gen.GenTxs) // https://github.com/osiz-blockchainapp/pound-sdk/issues/5086
