...
type UnbondingDelegationEntry struct {
	...
	InitialBalance sdk.Int   `json:"initial_balance" yaml:"initial_balance"` // bps's initially scheduled to receive at completion
	Balance        sdk.Int   `json:"balance" yaml:"balance"`                 // bps's to receive at completion
}
