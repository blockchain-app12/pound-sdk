...
import (
	...
	params "github.com/osiz-blockchainapp/pound-sdk/x/params/subspace"
)
...
type DepositParams struct {
	...
	MaxDepositPeriod time.Duration `json:"max_deposit_period,omitempty" yaml:"max_deposit_period,omitempty"` //  Maximum period for Bps holders to deposit on a proposal. Initial value: 2 months
}
