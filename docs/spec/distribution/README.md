...
worth of your existing _accum_. See [#2764](https://github.com/osiz-blockchainapp/pound-sdk/issues/2764)
for further details.

## Affect on Staking

Charging commission on BPS provisions while also allowing for BPS-provisions
...
In conclusion, we can only have BPS commission and unbonded s
provisions or bonded bps provisions with no BPS commission, and we elect to
