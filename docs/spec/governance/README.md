...
The following specification uses *BPS* as the native staking token. The module
can be adapted to any Proof-Of-Stake blockchain by replacing *BPS* with the native
